...
public class ItemStonecutter extends ItemBlockVC implements ISubtypeFromStackPovider {

	public ItemStonecutter(Block block) {
		super(block);
		setMaxStackSize(1);
		setHasSubtypes(true);
	}
    ...
    public boolean placeBlockAt(ItemStack stack, EntityPlayer player, World world, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ, IBlockState newState) {
        ...
        if (state.getBlock() == this.block) {
            ...
            TEStonecutter te = (TEStonecutter) world.getTileEntity(pos);
            if (te != null) {
