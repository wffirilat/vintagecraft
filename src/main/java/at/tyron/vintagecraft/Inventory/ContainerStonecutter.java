...
public class ContainerStonecutter extends Container {
	...
	public TEStonecutter teTable;
	
	public ContainerStonecutter(InventoryPlayer inventoryplayer, TEStonecutter teTable) {
	...
	void initSlots() {		
		this.addSlotToContainer(new SlotStonecutter(containerInv, 0, 45, 56));
		this.addSlotToContainer(new SlotStonecutter(containerInv, 1, 94, 56));
